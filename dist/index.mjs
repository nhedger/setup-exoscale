...
//#endregion
//#region node_modules/@octokit/request/node_modules/@octokit/request-error/dist-src/index.js
...
var defaults_default = { headers: { "user-agent": `octokit-request.js/10.0.6 ${getUserAgent()}` } };
...
function escapeData$1(s) {
	return toCommandValue$1(s).replace(/%/g, "%25").replace(/\r/g, "%0D").replace(/\n/g, "%0A");
}
...
function issueFileCommand(command, message) {
	...
	fs.appendFileSync(filePath, `${toCommandValue$1(message)}${os$1.EOL}`, { encoding: "utf8" });
}
...
var HttpClientResponse = class {
	...
	readBody() {
		return __awaiter$16(this, void 0, void 0, function* () {
			return new Promise((resolve) => __awaiter$16(this, void 0, void 0, function* () {
...
var HttpClient = class {
	...
	*/
	getJson(requestUrl_1) {
		return __awaiter$16(this, arguments, void 0, function* (requestUrl, additionalHeaders = {}) {
	...
	postJson(requestUrl_1, obj_1) {
		return __awaiter$16(this, arguments, void 0, function* (requestUrl, obj, additionalHeaders = {}) {
	...
	*/
	...
	_processResponse(res, options) {
		return __awaiter$16(this, void 0, void 0, function* () {
			return new Promise((resolve, reject) => __awaiter$16(this, void 0, void 0, function* () {
...
const { access: access$1, appendFile: appendFile$1, writeFile: writeFile$2 } = promises;
const SUMMARY_ENV_VAR$1 = "GITHUB_STEP_SUMMARY";
var Summary$1 = class {
	constructor() {
		this._buffer = "";
	}
	...
	*/
	filePath() {
		return __awaiter$13(this, void 0, void 0, function* () {
			...
			const pathFromEnv = process.env[SUMMARY_ENV_VAR$1];
			if (!pathFromEnv) throw new Error(`Unable to find environment variable for $${SUMMARY_ENV_VAR$1}. Check if your runtime environment supports job summaries.`);
			try {
				yield access$1(pathFromEnv, constants.R_OK | constants.W_OK);
			} catch (_a) {
	...
	*/
	write(options) {
		return __awaiter$13(this, void 0, void 0, function* () {
			...
			yield (overwrite ? writeFile$2 : appendFile$1)(filePath, this._buffer, { encoding: "utf8" });
...
const { chmod, copyFile, lstat, mkdir, open, readdir, rename, rm, rmdir, stat: stat$1, symlink: symlink$1, unlink } = fs.promises;
...
function addPath(inputPath) {
	...
	else issueCommand$1("add-path", {}, inputPath);
...
const getInput = (name) => {
	return getInput$1(name) === "" ? void 0 : getInput$1(name);
};
//#endregion
//#region node_modules/@actions/tool-cache/node_modules/@actions/core/lib/utils.js
/**
* Sanitizes an input into a string so it can be passed into issueCommand safely
* @param input input to sanitize into a string
*/
...
//#endregion
//#region node_modules/@actions/tool-cache/node_modules/@actions/core/lib/command.js
/**
* Issues a command to the GitHub Actions runner
*
* @param command - The command name to issue
...
//#endregion
//#region node_modules/@actions/tool-cache/node_modules/@actions/core/lib/summary.js
...
//#endregion
//#region node_modules/dedent/dist/dedent.mjs
...
const setup = async (config) => {
	...
	try {
		await install(await download(options), options);
...
const download = async (options) => {
	try {
		return await downloadTool(await findAsset(await findRelease(options), options));
	} catch (error) {
...
const findAsset = async (releaseId, options) => {
	...
	if (!asset) throw new Error(`Could not find an Exoscale CLI release for ${options.platform}/${options.architecture} matching ${pattern} for version ${options.version}.`);
	return asset.browser_download_url;
};
/**
* Finds the release asset filename suffix for the given platform and architecture.
*/
const findAssetPattern = (options) => {
	if (options.platform === "darwin") return "darwin_all.tar.gz";
	const architecture = new Map([["x64", "amd64"], ["arm64", "arm64"]]).get(options.architecture);
	if (!architecture) throw new Error(`Architecture ${options.architecture} is not supported by this action.`);
	if (options.platform === "linux") return `linux_${architecture}.tar.gz`;
	if (options.platform === "win32") return `windows_${architecture}.zip`;
	throw new Error(`Platform ${options.platform} is not supported by this action.`);
};
/**
...
const authenticate = async (options) => {
	if (!options.authentication || Object.entries(options.authentication ?? {}).some(([, value]) => !value)) {
		info$1("Not authenticating the Exoscale CLI as no authentication options were provided.");
		return;
	}
	const { account, zone, endpoint, key, secret } = options.authentication;
	info$1(`Authenticating the Exoscale CLI as ${account}.`);
